...
$("ol").append("5.I'm a mew list");

/* 6. Scratch that; the list is silly. Empty the aside and put a paragraph in it apologizing for the list’s existence. */
$("aside").empty().append('<p>Sorry the list is silly.</p>');

/* 7. When you change the numbers in the three inputs on the bottom, the background color 
